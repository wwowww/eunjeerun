        ...
        <ConfettiHoverEffect>
          <button onClick={openModal} aria-label="포트폴리오 설명, Github 링크, Blog 링크 확인 가능한 Modal 열기">
            <ul className={style.listWrap}>
              <li>
                <img src="/images/i.webp" alt="" loading="lazy" />
              </li>
              <li>
                <img src="/images/luv.webp" alt="" loading="lazy" />
              </li>
              <li>
                <img src="/images/e.webp" alt="" loading="lazy" />
              </li>
              <li>
                <img src="/images/j.webp" alt="" loading="lazy" />
              </li>
            </ul>
          </button>
        </ConfettiHoverEffect>
